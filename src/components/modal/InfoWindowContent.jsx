...
// const InfoWindowContent = ({ startAddress, endAddress, distance, duration }) => {
//     const hours = Math.floor(duration / 3600); // 시
//     const minutes = Math.floor((duration % 3600) / 60); // 분
...
//             </TitleWrapper>
//             <div>출발지: {startAddress}</div>
//             <div>도착지: {endAddress}</div>
//             <div>거리: {(distance / 1000).toFixed(1)} km</div>
//             <div>소요 시간: {hours}시간 {minutes}분</div>
//         </Container>
//     );
// };
